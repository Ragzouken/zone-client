...
test.each(filterToSpansTests)("filterToSpans", (input: string,
                                                pattern: RegExp, 
...
const tokeniseTests: TokeniseTestCase[] = [
    ...
    [
        "hello{el}joe", 
        [["text", "hello"], ["markup", "el"], ["text", "joe"]],
    ],
    [
        "{el}hello{ep}robert", 
        [["markup", "el"], ["text", "hello"], ["markup", "ep"], ["text", "robert"]],
    ],
    [
        "hello{ep}my name is mark{el}",
        [["text", "hello"], ["markup", "ep"], ["text", "my name is mark"], ["markup", "el"]],
    ],
    [
        "hello{test}joe", 
        [["text", "hello"], ["markup", "test"], ["text", "joe"]],
    ],
];
